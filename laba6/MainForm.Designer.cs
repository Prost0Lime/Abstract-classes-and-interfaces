...
namespace laba6
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(244, 51);
			this.button2.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.button2.Name = "button2";
			this.button2.Size = new System.Drawing.Size(97, 19);
			this.button2.TabIndex = 2;
			this.button2.Text = "шестиугольник";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.Button2Click);
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(244, 75);
			...
			this.Name = "MainForm";
			this.Text = "Абстрактные классы и интерфейсы";
